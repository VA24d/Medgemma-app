...
interface InferenceEngine {
    ...
    /**
     * Sends a user prompt with a loaded image and returns a Flow of generated tokens.
     */
    fun sendImagePrompt(message: String, predictLength: Int = DEFAULT_PREDICT_LENGTH): Flow<String>

    /**
     * Check if multimodal (vision) support is available.
     */
    fun hasMultimodal(): Boolean
